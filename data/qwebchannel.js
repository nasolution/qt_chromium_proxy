...
var qt_web_channel = new QWebChannel(qt.webChannelTransport, function(channel) {
    // To make the object known globally, assign it to the window object, i.e.:
    // var _kv_ = channel.objects._kv_;

    // _kv_.loadArchive("1", "2", "3");

    window._kv_ = channel.objects._kv_;

    //_kv_.loadArchive("I am in the qt_web_channel", "2", "3");

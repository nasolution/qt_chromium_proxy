...
TabWidget::TabWidget(QWebEngineProfile *profile, QWidget *parent, bool isMain)
    : QTabWidget(parent)
    , m_profile(profile)
{
    _isMain = isMain;
...
void TabWidget::onViewArchiveRequestedByKv(const QString& url, const QString& archiveId, const QString& jsonText)
{
